...
const columHelperMaterial = createColumnHelper<Material>(); //helper para la creacion de tablas usando typescript
const columns = [
  columHelperMaterial.accessor("name", {
    header: () => "Material",
    cell: (info) => (
  ...
  columHelperMaterial.accessor("code", {
    header: () => "Codigo",
    cell: (info) => (
  ...
  columHelperMaterial.accessor("material_type_name", {
  ...
  columHelperMaterial.accessor("description", {
    header: () => "Descripcion",
